...
fn check_debug_layer_available() -> bool {
    #[cfg(debug_assertions)]
    {
        ...
        // Missing Graphics Tools / DXGI debug SDK is normal on developer machines
        // without the optional Windows feature installed. Treat that as "no debug
        // layer" rather than logging ERROR — `get_dxgi_factory` already warns.
